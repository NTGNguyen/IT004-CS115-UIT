...
ALTER TABLE LOP ADD CONSTRAINT FK02_LOP FOREIGN KEY(MAGVCN) REFERENCES GIAOVIEN(MAGV)
-- HOCVIEN 
ALTER TABLE HOCVIEN ADD CONSTRAINT pk__HV PRIMARY KEY(MAHOCVIEN)
ALTER TABLE HOCVIEN ADD CONSTRAINT FK_HV FOREIGN KEY(MALOP) REFERENCES LOP(MALOP)
-- GIANGDAY
ALTER TABLE GIANGDAY ADD CONSTRAINT FK01_GD FOREIGN KEY(MALOP) REFERENCES LOP(MALOP)
ALTER TABLE GIANGDAY ADD CONSTRAINT FK02_GD FOREIGN KEY(MAMH) REFERENCES MONHOC(MAMH)
...
AND gv.MAGV IN (SELECT MAGVCN FROM LOP WHERE MALOP = 'K11')
--8. Tìm họ tên lớp trưởng của các lớp mà giáo viên có tên “Nguyen To Lan” dạy môn “Co So Du Lieu”.
SELECT HO,TEN
FROM HOCVIEN hv
JOIN LOP l ON hv.MAHV = l.TRGLOP
JOIN GIANGDAY gd ON l.MALOP = gd.MALOP
WHERE gd.MAGV IN (SELECt MAGV FROM GIAOVIEN WHERE HOTEN = 'Nguyen To Lan') AND gd.MAMH in (SELECT MAMH FROM MONHOC WHERE TENMH = 'Co So Du Lieu')
...
WHERE dk.MAMH IN (SELECT MAMH FROM MONHOC WHERE TENMH = 'Co So Du Lieu')
...
WHERE dk.MAMH_TRUOC IN (SELECT MAMH FROM MONHOC WHERE TENMH = 'Cau Truc Roi Rac')
...
JOIN KHOA k ON gv.MAKHOA = mh.MAKHOA
...
FROM GIAOVIEN gv
JOIN GIANGDAY gd ON gd.MAGV = gv.MAGV
GROUP BY HOTEN,gd.MAGV,HOCKY,NAM) t1
WHERE SoLop >=2
...
FROM HOCVIEN hv
JOIN KETQUATHI kqt ON hv.MAHV = kqt.MAHV
WHERE  MAMH = 'CSDL'  AND kqt.LANTHI = (SELECT MAX(LANTHI)
    FROM KETQUATHI
    WHERE MAHV = kqt.MAHV
    AND MAMH = 'CSDL')

--18. Danh sách học viên và điểm thi môn “Co So Du Lieu” (chỉ lấy điểm cao nhất của các lần thi).
SELECT hv.MAHV,MAX(DIEM) Diemcaonhat
FROM HOCVIEN hv
JOIN KETQUATHI kqt ON hv.MAHV = kqt.MAHV
WHERE MAMH= 'CSDL'
GROUP BY hv.MAHV
...
SELECT COUNT(*) SoGVGSPGS
FROM GIAOVIEN
WHERE HOCHAM = 'GS' OR HOCHAM = 'PGS'
--21. Thống kê có bao nhiêu giáo viên có học vị là “CN”, “KS”, “Ths”, “TS”, “PTS” trong mỗi khoa.
SELECT k.MAKHOA,TENKHOA,COUNT(MAGV) SoGV
FROM KHOA k
JOIN GIAOVIEN gv ON gv.MAKHOA = k.MAKHOA
WHERE gv.HOCVI IN ('CN','KS','Ths','TS','PTS')
GROUP BY k.MAKHOA,TENKHOA
--22. Mỗi môn học thống kê số lượng học viên theo kết quả (đạt và không đạt).
SELECT MAMH ,COUNT(CASE WHEN KQUA = 'Dat' THEN 1 END) KQdat,COUNT(CASE WHEN KQUA = 'Khong Dat' THEN 1 END) KQKhongDat
FROM KETQUATHI
GROUP BY MAMH
